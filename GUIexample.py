...
leftFrame.grid(row=0, column=0, padx=10, pady=2)  #pad is area around the frame between other frames
#can use ipadx to increase padding on the interior of the frame

Label(leftFrame, text="Instructions:").grid(row=0, column=0, sticky=W, padx=10, pady=2)
#Sticky puts text at top, bottom, left or right of frame otherwise deafualt is center


Instruct = Label(leftFrame, text="Choose a color")
